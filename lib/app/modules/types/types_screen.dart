...
//                   ),
//                   IconButton(
//                     icon: Icon(Icons.refresh, color: Color.fromARGB(255, 0, 173, 253)),
//                     onPressed: () {
//                       typesController.fetchTypes();
//                     },
//                   ),
//                 ],
//               ),
...
//                 itemCount: typesController.typesList.length,
//                 itemBuilder: (context, index) {
//                   final types = typesController.typesList[index];
